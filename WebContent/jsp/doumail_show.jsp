...
<head>
    ...
    <title>与${sessionScope.nickname}的邮箱</title>
...
<div id="main_content">
    <div id="main_content-left">
        ...
        <div id="main_content-left-top">
            <div>
                <h1 style="margin-bottom: 20px;">与${sessionScope.nickname}的邮箱</h1>
            </div>
    ...
    <div id="main_content-left-centre">
        ...
        <div class="doumail-form-div">
            ...
            <%--对话--隐藏表单 --%>
            <form action="/iDouBan/DoumailServlet?pre_method=doumail_content&method=doumail_show" id="onSubmit"
                  name="doumail_form" method="post">
                <!-- 发表对话的文本框 -->
                <div class="item">
                    <textarea name="doumail-place" required id="doumail-textarea" rows="4" cols="64"
                              onKeyUp="checkMaxInput(this)" onKeyDown="checkMaxInput(this)" style="border-radius: 8px;font-size: x-large;background-color: rgba(102,102,153,0.58)"></textarea>
                    <br>
                </div>
        ...
        <div id="paging">
						 		<span id="page_number">
								当前第 <strong> <span id="currentPage_num"> </span> </strong> 页，总共 <strong> <span
                                        id="totalPage_num"> </span> </strong> 页
								</span>
...
<script type="text/javascript">
    ...
    function toAjax(c) {
        ...
        xmlHttpRequest.open("post", "/iDouBan/DoumailServlet", true);
