...
<style type="text/css">
    body {
        ...
        background: url("http://localhost:8080/iDouBan/portrait/bg.jpg") no-repeat fixed center center;
...
<form action="/iDouBan/RegisterServlet" method="post" id="register_form">
    <div id="register">
        ...
        <a href="http://localhost:8080/iDouBan/jsp/login.jsp" style="color: #1E90FF">已有账号？登录</a>
