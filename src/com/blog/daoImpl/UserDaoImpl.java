...
import com.blog.util.MyDataSource;
...
@Override
	public int register(User user){
		...
		try {
			//获取数据库连接池中的一个连接
			con = dataSource.getConnection();
			String sql="insert into user (username,password,status,portrait) values (?,?,0,'http://localhost:8080/iDouBan/image/default.jpg')";
...
public int personage(User user) {
	...
	try {
		...
		System.out.println(user.getSelfIntroduc());
